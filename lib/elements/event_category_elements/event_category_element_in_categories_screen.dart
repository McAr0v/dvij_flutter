...
import 'package:dvij_flutter/screens/event_categories_screens/event_category_add_or_edit_screen.dart';
...
class EventCategoryElementInCategoriesScreen extends StatelessWidget {
  ...
  const EventCategoryElementInCategoriesScreen({
    Key? key,
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                        builder: (context) => EventCategoryAddOrEditScreen(eventCategory: eventCategory),
                      ),
                    );
                  },
                ),
