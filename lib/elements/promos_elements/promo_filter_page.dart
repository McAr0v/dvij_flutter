...
import 'package:dvij_flutter/elements/promos_elements/promo_category_picker_page.dart';
...
class PromoFilterPage extends StatefulWidget {
  ...
  @override
  _PromoFilterPageState createState() => _PromoFilterPageState();
}

// -- Виджет отображения фильтра в мероприятиях ---

class _PromoFilterPageState extends State<PromoFilterPage> {

  // ---- Объявляем переменные ----

  List<PromoCategory> categories = [];
  PromoCategory chosenCategory = PromoCategory(name: '', id: '');
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ClearItemWidget(
                              ...
                              onButtonPressed: (){
                                setState(() {
                                  chosenCategory = PromoCategory(name: '', id: '');
                                });
                              }
                          ),
                ...
                children: [
                  CustomButton(
                    ...
                    onTapMethod: (){
                      ...
                      List<dynamic> arguments = [chosenCity, chosenCategory, today, onlyFromPlaceEvents, selectedStartDatePeriod, selectedEndDatePeriod];
