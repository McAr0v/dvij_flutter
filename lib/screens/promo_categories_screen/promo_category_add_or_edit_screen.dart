...
class PromoCategoryAddOrEditScreen extends StatefulWidget {
  ...
  @override
  _PromoCategoryAddOrEditScreenState createState() => _PromoCategoryAddOrEditScreenState();
}
...
class _PromoCategoryAddOrEditScreenState extends State<PromoCategoryAddOrEditScreen> {
  ...
  void _publishEventCategory() async {
    ...
    if (widget.promoCategory != null) {
      ...
      result = await PromoCategory.addAndEditPromoCategory(categoryName, id: widget.promoCategory?.id ?? '');

    } else {
      // Создание нового города
      result = await PromoCategory.addAndEditPromoCategory(categoryName);
