...
class CreateOrEditPromoScreen extends StatefulWidget {
  ...
  @override
  _CreateOrEditPromoScreenState createState() => _CreateOrEditPromoScreenState();

}

// ----- ЭКРАН РЕДАКТИРОВАНИЯ ПРОФИЛЯ -------

class _CreateOrEditPromoScreenState extends State<CreateOrEditPromoScreen> {
  ...
  Future<void> _initializeData() async {
    ...
    chosenCity = City.getCityNameInCitiesList(widget.promoInfo.city);
