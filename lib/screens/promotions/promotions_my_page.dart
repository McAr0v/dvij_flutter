...
import 'package:dvij_flutter/elements/promos_elements/promo_filter_page.dart';
...
import 'package:dvij_flutter/screens/promotions/promo_view_page.dart';
...
import '../events/create_or_edit_event_screen.dart';
...
class PromotionsMyPage extends StatefulWidget {
  ...
  @override
  _PromotionsMyPageState createState() => _PromotionsMyPageState();
}



class _PromotionsMyPageState extends State<PromotionsMyPage> {
  ...
  Future<void> _initializeData() async {
    ...
    if (PromoCustom.currentMyPromoList.isEmpty){
      // ---- Если список пуст ----
      // ---- И Юзер залогинен
      // ---- Считываем с БД заведения -----

      if (UserCustom.currentUser?.uid != null && UserCustom.currentUser?.uid != ''){
        tempPromosList = await PromoCustom.getMyPromos(UserCustom.currentUser!.uid);
      }
      ...
      tempPromosList = PromoCustom.currentMyPromoList;
      ...
      body: RefreshIndicator (
        ...
        onRefresh: () async {
          ...
          if (UserCustom.currentUser?.uid != null || UserCustom.currentUser?.uid != ''){
            ...
            List<PromoCustom> tempEventsList = await PromoCustom.getMyPromos(UserCustom.currentUser!.uid);
