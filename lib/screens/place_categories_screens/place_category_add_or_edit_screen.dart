...
class PlaceCategoryEditScreen extends StatefulWidget {
  ...
  @override
  _PlaceCategoryEditScreenState createState() => _PlaceCategoryEditScreenState();
}
...
class _PlaceCategoryEditScreenState extends State<PlaceCategoryEditScreen> {
  ...
  void _publishPlaceCategory() async {
    ...
    String placeCategoryName = _categoryNameController.text;

    String result;

    if (widget.placeCategory != null) {
      // Редактирование города
      result = await PlaceCategory.addAndEditPlaceCategory(placeCategoryName, id: widget.placeCategory?.id ?? '');

    } else {
      // Создание нового города
      result = await PlaceCategory.addAndEditPlaceCategory(placeCategoryName);
